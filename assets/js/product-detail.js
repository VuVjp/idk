...
const products = {
  ...
  "2": {
    ...
    id: "2",
    reviews: [
      "<b>VuVjp</b>: Đồ họa đẹp, gameplay mượt.",
      "<b>minhtinhk5</b>: Âm thanh sống động, rất nhập tâm.",
      "<b>Bac-chan</b>: Game cuốn từ đầu đến cuối."
    ]
  },
  "3": {
    ...
    id: "3",
    reviews: [
      "<b>VuVjp</b>: Cốt truyện hấp dẫn, nhiều bất ngờ.",
      "<b>minhtinhk5</b>: Hơi ngắn nhưng chất lượng.",
      "<b>Bac-chan</b>: Chơi hoài không chán."
    ]
  },
  "4": {
    name: "Split Fiction",
    ...
    id: "4",
    reviews: [
      "<b>VuVjp</b>: Đáng từng phút giây trải nghiệm.",
      "<b>minhtinhk5</b>: Hệ thống chiến đấu đã tay.",
      "<b>Bac-chan</b>: Cách xây dựng thế giới rất ấn tượng."
    ]
  },
  "5": {
    name: "Blue Prince",
    ...
    id: "5",
    reviews: [
      "<b>VuVjp</b>: Nhân vật thiết kế có chiều sâu.",
      "<b>minhtinhk5</b>: Phù hợp cả game thủ mới lẫn kỳ cựu.",
      "<b>Bac-chan</b>: Độ khó cân bằng, không quá gắt."
    ]
  },
  "6": {
    ...
    id: "6",
    reviews: [
      "<b>VuVjp</b>: Lúc đầu hơi chậm, về sau rất hay.",
      "<b>minhtinhk5</b>: Đầy tính chiến thuật và sáng tạo.",
      "<b>Bac-chan</b>: Cảnh hành động rất mãn nhãn."
    ]
  },
  "7": {
    ...
    id: "7",
    reviews: [
      "<b>VuVjp</b>: Lỗi hơi nhiều, mong được cập nhật.",
      "<b>minhtinhk5</b>: Đúng chất giải trí cuối tuần.",
      "<b>Bac-chan</b>: Thích hợp chơi coop với bạn bè."
    ]
  },
  "8": {
    ...
    id: "8",
    reviews: [
      "<b>VuVjp</b>: Tối ưu tốt, máy yếu vẫn chơi ổn.",
      "<b>minhtinhk5</b>: Góc nhìn đẹp, điều khiển linh hoạt.",
      "<b>Bac-chan</b>: Càng chơi càng mê."
    ]
  },
  "9": {
    name: "R.E.P.O",
    ...
    id: "9",
    reviews: [
      "<b>VuVjp</b>: Phản hồi tay cầm rất chân thực.",
      "<b>minhtinhk5</b>: Map rộng, nhiều thứ để khám phá.",
      "<b>Bac-chan</b>: Hệ thống nâng cấp nhân vật hợp lý."
    ]
  },
  "10": {
    name: "HELLDIVERS™ 2",
    ...
    id: "10",
    reviews: [
      "<b>VuVjp</b>: Có chiều sâu và dễ nghiện.",
      "<b>minhtinhk5</b>: Nhiều ending, chơi lại không chán.",
      "<b>Bac-chan</b>: Cảm giác thành tựu rất rõ ràng."
    ]
  },
  "11": {
...
`,
    ...
    id: "11",
    reviews: [
      "<b>VuVjp</b>: Cảm giác thành tựu rất rõ ràng.",
      "<b>minhtinhk5</b>: NPC có tương tác thú vị.",
      "<b>Bac-chan</b>: Cảnh vật rất có hồn."
    ]
  },
  "12": {
    name: "Rust",
    ...
    id: "12",
    reviews: [
      "<b>VuVjp</b>: Game có phong cách riêng biệt.",
      "<b>minhtinhk5</b>: Cơ chế điều khiển cần thời gian làm quen.",
      "<b>Bac-chan</b>: Hơi thiếu nội dung endgame."
    ]
  },
  "13": {
    ...
    id: "13",
    reviews: [
      "<b>VuVjp</b>: Mức giá xứng đáng với chất lượng.",
      "<b>minhtinhk5</b>: Pha trộn nhiều thể loại khá độc đáo.",
      "<b>Bac-chan</b>: Hơi nặng grind nhưng chấp nhận được."
    ]
  },
  "14": {
  ...
  "15": {
    ...
    id: "15",
    reviews: [
      "<b>VuVjp</b>: Đáng để đầu tư thời gian.",
      "<b>minhtinhk5</b>: Chiến dịch hấp dẫn và nhiều chế độ chơi.",
      "<b>Bac-chan</b>: Thế giới mở đầy màu sắc."
    ]
  },
  "16": {
    ...
    description:`Resident Evil 4: 6 năm đã trôi qua kể từ thảm họa sinh học ở Thành phố Raccoon. Leon S. Kennedy theo dõi cô con gái mất tích của tổng thống đến một ngôi làng hẻo lánh ở Châu Âu, nơi có điều gì đó vô cùng sai trái với dân làng. Với lối chơi hiện đại, cốt truyện được tưởng tượng lại và đồ họa chi tiết sống động, Resident Evil 4 đánh dấu sự tái sinh của một gã khổng lồ trong ngành. Sống lại cơn ác mộng đã cách mạng hóa thể loại kinh dị sinh tồn.`,
    genre: ["Hành động", "Kinh dị"],
    tags: ["act", "horror"],
    id: "16",
    reviews: [
      "<b>VuVjp</b>: Boss khó nhưng thỏa mãn khi hạ được.",
      "<b>minhtinhk5</b>: Gameplay đa dạng, ít bị lặp lại.",
      "<b>Bac-chan</b>: Từng chi tiết đều được chăm chút."
    ]
  },
  "17": {
    name: "Hades II",
    ...
    id: "17",
    reviews: [
      "<b>VuVjp</b>: Nhiều bug nhỏ nhưng không ảnh hưởng nhiều.",
      "<b>minhtinhk5</b>: Có phần hướng dẫn rõ ràng, dễ tiếp cận.",
      "<b>Bac-chan</b>: Thời lượng chơi dài, không bị kéo dài vô lý."
    ]
  },
  "18": {
    ...
    id: "18",
    reviews: [
      "<b>VuVjp</b>: Thường xuyên có cập nhật mới.",
      "<b>minhtinhk5</b>: Cộng đồng người chơi khá tích cực.",
      "<b>Bac-chan</b>: Đáng chơi cả solo lẫn multiplayer."
    ]
  },
  "19": {
    name: "Dragon Kingdom",
    ...
    id: "19",
    reviews: [
      "<b>VuVjp</b>: Cảm giác điều khiển rất tự nhiên.",
      "<b>minhtinhk5</b>: Không phải tuyệt đối, nhưng rất đáng thử.",
      "<b>Bac-chan</b>: Cốt truyện sâu sắc hơn mong đợi."
    ]
  },
  "20": {
    name: "Cyberpunk 2077",
    ...
    id: "20",
    reviews: [
      "<b>VuVjp</b>: Đúng kiểu chơi một phát là dính",
      "<b>minhtinhk5</b>: Nhiệm vụ phụ khá thú vị..",
      "<b>Bac-chan</b>: Hơi nhiều cutscene, nhưng đẹp."
    ]
  },
  "21": {
    name: "Elden Ring",
    ...
    id: "21",
    reviews: [
      "<b>VuVjp</b>: Gameplay loop gây nghiện.",
      "<b>minhtinhk5</b>: Có vài đoạn hơi thiếu cân bằng.",
      "<b>Bac-chan</b>: Cơ chế stealth làm tốt."
    ]
  },
  "22": {
    ...
    id: "22",
    reviews: [
      "<b>VuVjp</b>: Đánh boss cần tính toán, không đơn giản.",
      "<b>minhtinhk5</b>: Vũ khí thiết kế rất sáng tạo.",
      "<b>Bac-chan</b>: Hệ thống kỹ năng hợp lý, dễ hiểu."
    ]
  },
  "23": {
    name: "Starfield",
    ...
    id: "23",
    reviews: [
      "<b>VuVjp</b>: Game có nhịp độ ổn định.",
      "<b>minhtinhk5</b>: Đáng giá từng đồng bỏ ra.",
      "<b>Bac-chan</b>: Nhạc nền tăng trải nghiệm rõ rệt."
    ]
  },
  "24": {
    ...
    id: "24",
    reviews: [
      "<b>VuVjp</b>: Giao diện người dùng đẹp và dễ nhìn.",
      "<b>minhtinhk5</b>: Phần tutorial ngắn gọn, dễ nắm.",
      "<b>Bac-chan</b>: Hơi lặp lại về cuối game."
    ]
  },
  "25": {
    ...
    id: "25",
    reviews: [
      "<b>VuVjp</b>: Nhân vật phụ được chăm chút.",
      "<b>minhtinhk5</b>: Phản diện có động cơ rõ ràng.",
      "<b>Bac-chan</b>: Đồ họa đỉnh, kể cả trên console cũ."
    ]
  },
  "26": {
    ...
    id: "26",
    reviews: [
      "<b>VuVjp</b>: Lối chơi đậm chất cá nhân.",
      "<b>minhtinhk5</b>: Nhiều tính năng tùy chỉnh hay ho.",
      "<b>Bac-chan</b>: Có nhiều mini game thư giãn."
    ]
  },
  "27": {
    name: "It Takes Two",
    ...
    id: "27",
    reviews: [
      "<b>VuVjp</b>: Boss thiết kế độc đáo, không nhàm.",
      "<b>minhtinhk5</b>: Khám phá bản đồ cảm giác rất đã.",
      "<b>Bac-chan</b>: Hơi nhiều màn chơi kéo dài không cần thiết."
    ]
  },
  "28": {
    ...
    id: "28",
    reviews: [
      "<b>VuVjp</b>: Mỗi chapter đều có điểm nhấn.",
      "<b>minhtinhk5</b>: Lỗi hiếm gặp nhưng đôi lúc khá khó chịu.",
      "<b>Bac-chan</b>: Dàn nhân vật chính rất hợp vai."
    ]
  },
  "29": {
    ...
    id: "29",
    reviews: [
      "<b>VuVjp</b>: Trang phục và skin đẹp, không quá lố.",
      "<b>minhtinhk5</b>: Có chiều sâu chiến thuật rõ rệt.",
      "<b>Bac-chan</b>: Bản dịch ngôn ngữ tốt, ít lỗi."
    ]
  },
  "30": {
    name: "Stray",
    ...
    id: "30",
    reviews: [
      "<b>VuVjp</b>: Game phù hợp chơi nhiều lần.",
      "<b>minhtinhk5</b>: Nhiều Easter egg thú vị.",
      "<b>Bac-chan</b>: Pha trộn giữa hành động và kể chuyện tốt."
    ]
  },
  "31": {
    ...
    id: "31",
    reviews: [
      "<b>VuVjp</b>: Dễ gây nghiện dù gameplay đơn giản.",
      "<b>minhtinhk5</b>: Nhẹ nhưng chơi vẫn đã.",
      "<b>Bac-chan</b>: Combat rất mượt, phản hồi nhanh."
    ]
  },
  "32": {
    name: "Alan Wake II",
  ...
  "33": {
    ...
    id: "33",
    reviews: [
      "<b>VuVjp</b>: Có vài phần chơi hơi thử thách quá mức.",
      "<b>minhtinhk5</b>: Môi trường sống động và chi tiết.",
      "<b>Bac-chan</b>: Game có chiều sâu hơn vẻ ngoài."
    ]
  },
  "34": {
    ...
    id: "34",
    reviews: [
      "<b>VuVjp</b>: Đáng để giới thiệu cho bạn bè.",
      "<b>minhtinhk5</b>: Hiệu ứng thời tiết tạo bầu không khí tốt.",
      "<b>Bac-chan</b>: Cảnh cuối cảm động, ấn tượng."
    ]
  },
  "35": {
    name: "Atomic Heart",
    ...
    id: "35",
    reviews: [
      "<b>VuVjp</b>: Kỹ xảo rất mượt, không bị khựng hình.",
      "<b>minhtinhk5</b>: Chiến dịch hấp dẫn và nhiều chế độ chơi.",
      "<b>Bac-chan</b>: Giá hợp lý với chất lượng."
    ]
  },
  "36": {
    ...
    reviews: [
      "<b>VuVjp</b>: Game rất hay, đồ họa đỉnh cao!",
      "<b>minhtinhk5</b>: Lúc đầu hơi rối, sau quen là cuốn.",
      "<b>Bac-chan</b>: Không dài dòng, đi thẳng vào gameplay."
    ]
  },
  "37": {
    ...
    id: "37",
    reviews: [
      "<b>VuVjp</b>: Mỗi loại vũ khí cho cảm giác khác nhau.",
      "<b>minhtinhk5</b>: Từng nhiệm vụ đều mang dấu ấn riêng.",
      "<b>Bac-chan</b>: Hệ thống checkpoint hợp lý, không frustrate."
    ]
  },
  "38": {
    name: "Sea of Thieves",
    ...
    id: "38",
    reviews: [
      "<b>VuVjp</b>: Game chỉn chu từ âm thanh đến hình ảnh.",
      "<b>minhtinhk5</b>: Đúng chất giải trí, không cần suy nghĩ nhiều.",
      "<b>Bac-chan</b>: Mỗi màn chơi đều có bất ngờ riêng."
    ]
  },
  "39": {
    name: "Lies of P",
    ...
    id: "39",
    reviews: [
      "<b>VuVjp</b>: Lối chơi dễ tiếp cận nhưng khó thành thạo.",
      "<b>minhtinhk5</b>: Tính năng online hoạt động ổn định.",
      "<b>Bac-chan</b>: Có thể chơi cả ngày mà không chán."
    ]
  },
  "40": {
    name: "Palworld",
    ...
    id: "40",
    reviews: [
      "<b>VuVjp</b>: Cảnh cháy nổ làm rất thật.",
      "<b>minhtinhk5</b>: Hệ thống crafting thú vị, không quá phức tạp.",
      "<b>Bac-chan</b>: Phong cách đồ họa rất đặc trưng."
    ]
  },
  "41": {
    ...
    id: "41",
    reviews: [
      "<b>VuVjp</b>: Game nhẹ nhưng nội dung đầy đủ.",
      "<b>minhtinhk5</b>: Mỗi lần chơi lại có trải nghiệm khác.",
      "<b>Bac-chan</b>: Cảm giác thắng trong game rất thỏa mãn."
    ]
  },
  "42": {
    ...
    id: "42",
    reviews: [
      "<b>VuVjp</b>: Một trong những game đáng nhớ nhất.",
      "<b>minhtinhk5</b>: Màn chơi cuối làm rất tốt.",
      "<b>Bac-chan</b>: Một tựa game khó bỏ qua."
    ]
  },
  "43": {
    name: "No Man's Sky",
    ...
    id: "43",
    reviews: [
      "<b>VuVjp</b>: Hướng dẫn trong game rất chi tiết.",
      "<b>minhtinhk5</b>: Có tính giải trí và nghệ thuật song song.",
      "<b>Bac-chan</b>: Hệ thống save linh hoạt, dễ quản lý."
    ]
  },
  "44": {
    name: "Control",
    ...
    id: "44",
    reviews: [
      "<b>VuVjp</b>: Vũ khí nâng cấp cảm thấy rõ hiệu quả.",
      "<b>minhtinhk5</b>: Tận dụng tốt hiệu ứng âm thanh.",
      "<b>Bac-chan</b>: Các animation rất mượt mà."
    ]
  },
  "45": {
    name: "The Forest",
    ...
    id: "45",
    reviews: [
      "<b>VuVjp</b>: Game giúp giảm stress hiệu quả.",
      "<b>minhtinhk5</b>: Thiết kế kẻ địch độc đáo và đa dạng.",
      "<b>Bac-chan</b>: Đôi lúc cảm thấy game hơi dễ."
    ]
  },
  "46": {
    name: "Slay the Spire",
  ...
  "47": {
    ...
    id: "47",
    reviews: [
      "<b>VuVjp</b>: Mỗi level có điểm nhấn riêng biệt.",
      "<b>minhtinhk5</b>: Cốt truyện có chiều sâu bất ngờ.",
      "<b>Bac-chan</b>: Gameplay tuy cũ mà vẫn cuốn."
    ]
  },
  "48": {
    ...
    id: "48",
    reviews: [
      "<b>VuVjp</b>: Có nhiều cách để vượt qua thử thách.",
      "<b>minhtinhk5</b>: Cơ chế multiplayer rất vui.",
      "<b>Bac-chan</b>: Game mang lại cảm giác hoài niệm."
    ]
  },
  "49": {
    name: "Outer Wilds",
    ...
    id: "49",
    reviews: [
      "<b>VuVjp</b>: Có thể chơi theo nhiều phong cách khác nhau.",
      "<b>minhtinhk5</b>: Phần thưởng khi hoàn thành thử thách rất hợp lý.",
      "<b>Bac-chan</b>: Thích hợp chơi lại để khám phá hết."
    ]
  },
  "50": {
    name: "Doom Eternal",
    ...
    id: "50",
    reviews: [
      "<b>VuVjp</b>: Nhạc nền thay đổi linh hoạt theo tình huống.",
      "<b>minhtinhk5</b>: Khả năng tuỳ biến nhân vật tốt.",
      "<b>Bac-chan</b>: Hệ thống nhiệm vụ rõ ràng, không rối."
    ]
  },
  "51": {
    name: "Minecraft",
    ...
    id: "51",
    reviews: [
      "<b>VuVjp</b>: Lồng tiếng chất lượng, cảm xúc.",
      "<b>minhtinhk5</b>: Lỗi không đáng kể, không ảnh hưởng trải nghiệm.",
      "<b>Bac-chan</b>: Một game nên có trong bộ sưu tập."
    ]
  },
  "52": {
    name: "Valorant",
    ...
    id: "52",
    reviews: [
      "<b>VuVjp</b>: Dễ chơi nhưng không nhàm.",
      "<b>minhtinhk5</b>: Có chiều sâu nếu chịu khó khám phá.",
      "<b>Bac-chan</b>: Đặc sắc từ gameplay đến hình ảnh."
    ]
  },
  "53": {
    ...
    id: "53",
    reviews: [
      "<b>VuVjp</b>: Game mang phong cách riêng khó lẫn.",
      "<b>minhtinhk5</b>: Môi trường tương tác tốt, không bị chết.",
      "<b>Bac-chan</b>: NPC không chỉ để trang trí."
    ]
  },
  "54": {
    ...
    id: "54",
    reviews: [
      "<b>VuVjp</b>: Menu dễ dùng, bố cục hợp lý.",
      "<b>minhtinhk5</b>: Đúng chuẩn game đáng để chơi đi chơi lại.",
      "<b>Bac-chan</b>: Game hay nhưng boss hơi ăn gian."
    ]
  },
  "55": {
    ...
    reviews: [
      "<b>VuVjp</b>: Game rất hay, đồ họa đỉnh cao!",
      "<b>minhtinhk5</b>: Không biết vì sao nhưng chơi hoài không chán.",
      "<b>Bac-chan</b>: Giao diện đẹp nhưng hơi rối lúc đầu."
    ]
  },
  "56": {
    ...
    id: "56",
    reviews: [
      "<b>VuVjp</b>: Không biết vì sao nhưng chơi hoài không chán.",
      "<b>minhtinhk5</b>: Phần này mà có coop thì tuyệt vời.",
      "<b>Bac-chan</b>: Nhạc căng quá, tưởng bị jumpscare."
    ]
  },
  "57": {
    ...
    id: "58",
    reviews: [
      "<b>VuVjp</b>: Vào game thấy lag nhẹ, nhưng vẫn chấp nhận được.",
      "<b>minhtinhk5</b>: Tìm đường hơi rối, nhưng tìm ra rồi thấy vui.",
      "<b>Bac-chan</b>: Có những pha né đạn đúng kiểu “sát thủ ballet”."
    ]
  },
  "58": {
    name: "Planet Zoo",
    ...
    id: "58",
    reviews: [
      "<b>VuVjp</b>: Mỗi lần chết là một lần rút kinh nghiệm... hoặc phát cáu.",
      "<b>minhtinhk5</b>: Game vui nhưng NPC đôi khi hơi ngốc.",
      "<b>Bac-chan</b>: Cảnh đánh boss rất hoành tráng, hơi dài một chút."
    ]
  },
  "59": {
    ...
    id: "59",
    reviews: [
      "<b>VuVjp</b>: Map rộng thật nhưng cần xe đạp để đi cho nhanh.",
      "<b>minhtinhk5</b>: Càng chơi càng thấy mình... cần luyện kỹ hơn.",
      "<b>Bac-chan</b>: Có những khoảnh khắc khiến mình ngồi thở dốc."
    ]
  },
  "60": {
    name: "Metro Exodus",
    ...
    id: "60",
    reviews: [
      "<b>VuVjp</b>: Cơ chế ngắm bắn hơi khó lúc mới đầu.",
      "<b>minhtinhk5</b>: Nâng cấp đồ mất công nhưng rất xứng đáng.",
      "<b>Bac-chan</b>: Mất 3 tiếng chỉ để chỉnh outfit, không chơi gì luôn."
    ]
  },
  "61": {
    ...
    id: "61",
    reviews: [
      "<b>VuVjp</b>: Game đòi hỏi phản xạ tốt... mà mình thì chậm.",
      "<b>minhtinhk5</b>: Nhảy từ vách xuống nghe ụch mà phê.",
      "<b>Bac-chan</b>: Hệ thống đánh giá cuối màn khá công bằng."
    ]
  },
  "62": {
    ...
    id: "62",
    reviews: [
      "<b>VuVjp</b>: Chơi xong mà còn nằm mơ thấy game!",
      "<b>minhtinhk5</b>: Có vài bug giúp mình thắng dễ bất ngờ.",
      "<b>Bac-chan</b>: Mua game vì đồ họa, ở lại vì gameplay."
    ]
  },
  "63": {
    name: "Cuphead",
    ...
    id: "63",
    reviews: [
      "<b>VuVjp</b>: Cứ nghĩ đơn giản ai ngờ phức tạp thiệt.",
      "<b>minhtinhk5</b>: Cảm giác lần đầu thắng boss thật sung sướng.",
      "<b>Bac-chan</b>: Game dài, chơi cả tuần chưa hết."
    ]
  },
  "64": {
    name: "Celeste",
    ...
    id: "64",
    reviews: [
      "<b>VuVjp</b>: Game có hệ thống build rất đa dạng.",
      "<b>minhtinhk5</b>: Không hiểu sao lại vui khi loot được đồ tím.",
      "<b>Bac-chan</b>: Có cảm giác bị nghiện nhẹ."
    ]
  },
  "65": {
    name: "Subnautica",
    ...
    id: "",
    reviews: [
      "<b>VuVjp</b>: Hơi thiếu hướng dẫn cho người mới!",
      "<b>minhtinhk5</b>: Cơ chế bắn chính xác, đã tay.",
      "<b>Bac-chan</b>: Hành lang nhỏ mà lại đầy cảm xúc."
    ]
  },
  "66": {
    ...
    id: "66",
    reviews: [
      "<b>VuVjp</b>: Mỗi lần lên cấp cảm thấy “được công nhận”.",
      "<b>minhtinhk5</b>: Vào chơi thử, ai ngờ chơi 5 tiếng liền.",
      "<b>Bac-chan</b>: Tính chiến thuật cao, không thể lao vào bắn bừa."
    ]
  },
  "67": {
    name: "Hollow Knight",
    ...
    id: "67",
    reviews: [
      "<b>VuVjp</b>: Chơi lần đầu hơi hoang mang, chơi lần hai thành cao thủ.",
      "<b>minhtinhk5</b>: Tạo hình nhân vật rất có cá tính.",
      "<b>Bac-chan</b>: Nhiều skin đẹp mà phải cày cực."
    ]
  },
  "68": {
    name: "Slime Rancher",
    ...
    id: "68",
    reviews: [
      "<b>VuVjp</b>: Góc quay điện ảnh, chụp ảnh trong game siêu chất.",
      "<b>minhtinhk5</b>: Có những pha slow-motion rất đã mắt.",
      "<b>Bac-chan</b>: Hơi tiếc là không có voice tiếng Việt."
    ]
  },
  "69": {
    name: "Factorio",
    ...
    id: "69",
    reviews: [
      "<b>VuVjp</b>: Tìm nguyên liệu mà tưởng đi làm... nghề phụ.",
      "<b>minhtinhk5</b>: Cảnh cháy nổ mãn nhãn như phim hành động.",
      "<b>Bac-chan</b>: Nhân vật phụ chiếm luôn spotlight của chính."
    ]
  },
  "70": {
    name: "Ghostrunner",
    ...
    id: "70",
    reviews: [
      "<b>VuVjp</b>: Đánh trùm cần học thuộc lòng luôn cả pattern.",
      "<b>minhtinhk5</b>: Có thể chơi theo lối stealth hoặc đập vô mặt",
      "<b>Bac-chan</b>: Càng chơi càng khám phá ra chi tiết ẩn thú vị."
    ]
  },
  "71": {
    ...
    id: "71",
    reviews: [
      "<b>VuVjp</b>: Game đỉnh, chỉ tiếc là không có nhiều thời gian chơi.",
      "<b>minhtinhk5</b>: Càng về sau càng cuốn, như phim dài tập.",
      "<b>Bac-chan</b>: Giao diện đẹp nhưng đôi khi hơi nhiều chữ."
    ]
  },
  "72": {
    name: "Frostpunk",
    ...
    id: "72",
    reviews: [
      "<b>VuVjp</b>: Điểm cộng lớn cho nhạc nền siêu bắt tai.",
      "<b>minhtinhk5</b>: Có cảm giác từng chi tiết đều được chăm chút kỹ.",
      "<b>Bac-chan</b>: Game có chiều sâu, chơi lâu mới thấm."
    ]
  },
  "73": {
    ...
    reviews: [
      "<b>VuVjp</b>: Game rất hay, đồ họa đỉnh cao!",
      "<b>minhtinhk5</b>: Chiến dịch hấp dẫn và nhiều chế độ chơi.",
      "<b>Bac-chan</b>: Một cú twist cốt truyện khiến mình há hốc."
    ]
  },
  "74": {
    ...
    id: "74",
    reviews: [
      "<b>VuVjp</b>: Vừa chơi vừa phải suy nghĩ – đúng gu mình.!",
      "<b>minhtinhk5</b>: Cơ chế né đòn làm tốt bất ngờ..",
      "<b>Bac-chan</b>: Chơi một lần rồi lại muốn chơi thêm."
    ]
  },
  "75": {
    name: "Disco Elysium",
    ...
    id: "75",
    reviews: [
      "<b>VuVjp</b>: Gặp bug nhưng lại thấy buồn cười chứ không bực.",
      "<b>minhtinhk5</b>: Vừa chơi vừa phải để ý từng tiếng động.",
      "<b>Bac-chan</b>: Phù hợp cả chơi nghiêm túc lẫn vui vẻ chill chill."
    ]
  },
  "76": {
    ...
    id: "76",
    reviews: [
      "<b>VuVjp</b>: Không có gì để chê… ngoài độ khó.",
      "<b>minhtinhk5</b>: Tốn thời gian thật nhưng đáng lắm.",
      "<b>Bac-chan</b>: Gameplay hơi cũ nhưng vẫn rất có duyên."
    ]
  },
  "77": {
    name: "Stellaris",
    ...
    id: "77",
    reviews: [
      "<b>VuVjp</b>: Có vài đoạn pacing hơi chậm!",
      "<b>minhtinhk5</b>: Nếu có Việt hóa sẽ hoàn hảo hơn.",
      "<b>Bac-chan</b>: Phù hợp với fan lâu năm lẫn người mới.",
      "<b>DSN</b>: tôi bị gay nên tôi buồn."
    ]
  },
  "78": {
    name: "Tales of Arise",
    ...
    id: "78",
    reviews: [
      "<b>VuVjp</b>: Đồ họa tối ưu tốt, máy yếu vẫn chơi ngon.",
      "<b>minhtinhk5</b>: Gây nghiện theo cách rất riêng.",
      "<b>Bac-chan</b>: Chơi với bạn bè vui hơn nhiều."
    ]
  },
  "79": {
    name: "Dark Souls III",
    ...
    id: "79",
    reviews: [
      "<b>VuVjp</b>: Đã thử, giờ thì không dứt ra được.",
      "<b>minhtinhk5</b>: Vào game vì hype, ở lại vì gameplay.",
      "<b>Bac-chan</b>: Từng khung cảnh như một bức tranh."
    ]
  },
  "80": {
    name: "Death's Door",
    ...
    id: "80",
    reviews: [
      "<b>VuVjp</b>: Có cảm giác như mình thật sự ở trong game.",
      "<b>minhtinhk5</b>: Lúc combat cực kỳ adrenaline.",
      "<b>Bac-chan</b>: Hơi ít customization cho nhân vật."
    ]
  },
  "81": {
    name: "Gris",
    ...
    id: "81",
    reviews: [
      "<b>VuVjp</b>: Hơi ít customization cho nhân vật.",
      "<b>minhtinhk5</b>: Không phải kiệt tác nhưng rất đáng nhớ.",
      "<b>Bac-chan</b>: Có nét giống game cũ nhưng cải tiến rõ ràng."
    ]
  },
  "82": {
    name: "Valheim",
    ...
    id: "82",
    reviews: [
      "<b>VuVjp</b>: Bị cuốn theo cốt truyện lúc nào không hay.",
      "<b>minhtinhk5</b>: Hệ thống kỹ năng chia nhánh hợp lý.",
      "<b>Bac-chan</b>: Nhịp game nhanh, không bị lê thê."
    ]
  },
  "83": {
    name: "Psychonauts 2",
    ...
    id: "83",
    reviews: [
      "<b>VuVjp</b>: Một tựa game đáng để giới thiệu cho người khác.",
      "<b>minhtinhk5</b>: Dù có vài lỗi nhưng trải nghiệm tổng thể vẫn rất tốt.",
      "<b>Bac-chan</b>: Có những lúc chỉ muốn ngồi ngắm cảnh."
    ]
  },
  "84": {
    ...
    id: "84",
    reviews: [
      "<b>VuVjp</b>: Trùm cuối khiến mình nhớ mãi.",
      "<b>minhtinhk5</b>: Không hoành tráng, nhưng rất sâu sắc.",
      "<b>Bac-chan</b>: Game làm mình bất ngờ theo hướng tích cực."
    ]
  },
  "85": {
    name: "The Long Dark",
    ...
    id: "85",
    reviews: [
      "<b>VuVjp</b>: Cơ chế điều khiển tay cầm rất đã.",
      "<b>minhtinhk5</b>: Mỗi bản cập nhật đều đáng để quay lại chơi.",
      "<b>Bac-chan</b>: Khá thử thách, nhưng không gây ức chế."
    ]
  },
  "86": {
    name: "Inside",
    ...
    id: "86",
    reviews: [
      "<b>VuVjp</b>: Tự do lựa chọn lối chơi là điểm mạnh lớn.",
      "<b>minhtinhk5</b>: Khó tin đây là game indie.",
      "<b>Bac-chan</b>: Dù cày cuốc nhiều vẫn cảm thấy vui."
    ]
  },
  "87": {
    name: "RimWorld",
    ...
    id: "87",
    reviews: [
      "<b>VuVjp</b>: Giúp mình thư giãn sau ngày dài mệt mỏi.",
      "<b>minhtinhk5</b>: Vài chi tiết nhỏ làm game sống động hẳn lên.",
      "<b>Bac-chan</b>: Không quá hoành tráng nhưng rất có hồn."
    ]
  },
  "88": {
    name: "Hotline Miami",
    ...
    id: "88",
    reviews: [
      "<b>VuVjp</b>: Có lúc dừng lại chỉ để nghe nhạc trong game.",
      "<b>minhtinhk5</b>: Không phải siêu phẩm, nhưng là trải nghiệm cá nhân tuyệt vời.",
      "<b>Bac-chan</b>: Mỗi lần chơi lại như sống lại một câu chuyện khác."
    ]
  },
  "89": {
    name: "Tropico 6",
    ...
    id: "89",
    reviews: [
      "<b>VuVjp</b>: Nhân vật được xây dựng có chiều sâu, không hời hợt.",
      "<b>minhtinhk5</b>: Một tựa game khiến mình tin rằng game cũng là nghệ thuật.",
      "<b>Bac-chan</b>: Mỗi bước đi đều mang lại cảm giác khám phá."
    ]
  },
  "90": {
    name: "Returnal",
    ...
    id: "90",
    reviews: [
      "<b>VuVjp</b>: Một hành trình, không chỉ là một trò chơi.",
      "<b>minhtinhk5</b>: Lúc thắng thì vui, lúc thua thì muốn chơi lại ngay.",
      "<b>Bac-chan</b>: Kết thúc game mà như vừa chia tay một người bạn."
    ]
  },
  "91": {
    ...
    id: "91",
    reviews: [
      "<b>VuVjp</b>: Lưu giữ cảm xúc lâu hơn cả phim ảnh.",
      "<b>minhtinhk5</b>: Có thể không hoàn hảo, nhưng chân thành.",
      "<b>Bac-chan</b>: Đánh thức lại niềm đam mê game thời thơ ấu."
    ]
  },
  "92": {
    ...
    id: "92",
    reviews: [
      "<b>VuVjp</b>: Cảm giác hồi hộp mỗi lần mở hòm đồ quý hiếm.",
      "<b>minhtinhk5</b>: Game không dạy điều gì, nhưng để lại nhiều suy nghĩ.",
      "<b>Bac-chan</b>: Cách kể chuyện tinh tế, không cần phô trương."
    ]
  },
  "93": {
    ...
    id: "93",
    reviews: [
      "<b>VuVjp</b>: Có chiều sâu mà không cần phải phức tạp hóa.",
      "<b>minhtinhk5</b>: Mỗi chi tiết như một mảnh ghép tạo nên thế giới sống động.",
      "<b>Bac-chan</b>: Một trò chơi gợi cảm giác hoài cổ mà vẫn hiện đại."
    ]
  },
  "94": {
    ...
    id: "94",
    reviews: [
      "<b>VuVjp</b>: Hành trình khám phá trong game cũng là hành trình khám phá bản thân.",
      "<b>minhtinhk5</b>: Không ngờ chỉ vài cú click lại mang đến nhiều cảm xúc như vậy.",
      "<b>Bac-chan</b>: Thứ khiến mình quay lại không phải gameplay, mà là không khí."
    ]
  },
  "95": {
...
Người chơi vào vai Henri Clément, một binh sĩ Pháp trong Thế chiến thứ nhất, tỉnh dậy trong một boongke quân sự bỏ hoang và tối tăm. Anh hoàn toàn bị mắc kẹt, bị săn đuổi bởi một sinh vật bí ẩn và kinh hoàng. Nhiệm vụ của Henri là sống sót, khám phá bí ẩn của boongke, và tìm đường thoát ra.`,
    ...
    id: "95",
    reviews: [
      "<b>VuVjp</b>: Dù không nhiều lời thoại, vẫn kể được cả một câu chuyện.",
      "<b>minhtinhk5</b>: Cảm giác trở thành một phần của thế giới trong game là có thật.",
      "<b>Bac-chan</b>: Không ồn ào, nhưng âm thầm tạo dấu ấn."
    ]
  },
  "96": {
    name: "HITMAN 3",
...
Hitman 3 tiếp nối các sự kiện từ phần trước, khi Agent 47 cùng cộng sự Diana Burnwood và Lucas Grey tiến hành chiến dịch tiêu diệt tổ chức bí ẩn Providence – những kẻ thao túng thế giới từ trong bóng tối. Lần này, nhiệm vụ mang tính cá nhân sâu sắc, đẩy Agent 47 vào những quyết định khó khăn, hé lộ thêm nhiều bí mật trong quá khứ của anh.`,
    ...
    id: "96",
    reviews: [
      "<b>VuVjp</b>: Cảnh hoàng hôn trong game khiến mình ngừng di chuyển vài phút.",
      "<b>minhtinhk5</b>: Game mang lại cảm giác “được sống một cuộc đời khác”.",
      "<b>Bac-chan</b>: Một game khiến mình suy nghĩ mãi sau khi tắt máy."
    ]
  },
  "97": {
    name: "Dark Souls II",
    ...
    id: "97",
    reviews: [
      "<b>VuVjp</b>: Cảm xúc đôi khi còn thật hơn đời thật.",
      "<b>minhtinhk5</b>: Không cần nói nhiều – game này đủ làm bạn say",
      "<b>Bac-chan</b>: Một tựa game cho những người biết chậm lại và cảm nhận."
    ]
  },
  "98": {
    ...
    id: "98",
    reviews: [
      "<b>VuVjp</b>: Game nhỏ, cảm xúc lớn.",
      "<b>minhtinhk5</b>: Mỗi lần chơi là một lần trưởng thành hơn.",
      "<b>Bac-chan</b>: Không nhiều game khiến mình muốn viết review, nhưng game này thì có."
    ]
  },
  "99": {
    name: "Fallout 4",
    ...
    id: "99",
    reviews: [
      "<b>VuVjp</b>: Khi nhân vật buồn, mình cũng thấy nghèn nghẹn.!",
      "<b>minhtinhk5</b>: Cốt truyện nhẹ nhàng nhưng găm sâu vào tâm trí.",
      "<b>Bac-chan</b>: Từng bản nhạc, từng chi tiết đều có ý nghĩa riêng."
    ]
  },
  "100": {
    name: "Darksiders III",
    ...
    id: "100",
    reviews: [
      "<b>VuVjp</b>: Đơn giản nhưng làm tốt điều cốt lõi: chạm đến cảm xúc.",
      "<b>minhtinhk5</b>: Một trải nghiệm “càng chơi, càng quý”.",
      "<b>Bac-chan</b>: Dù kết thúc rồi, vẫn muốn quay lại."
    ]
  },
};
