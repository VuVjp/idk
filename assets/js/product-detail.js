...
`,
  ...
  "37": {
    ...
    description:`Little Nightmares II nhận được đánh giá tích cực khi phát hành. Các nhà phê bình khen ngợi đồ họa, bầu không khí và cải thiện chất lượng cuộc sống, một số người cho rằng nó vượt trội hơn so với phiên bản trước. Trong vòng một tháng sau khi phát hành, trò chơi đã bán được một triệu bản trên toàn thế giới. Phần tiếp theo, Little Nightmares III , đang được Supermassive phát triển để phát hành vào khoảng năm 2025.`,
    genre: ["Kinh dị", "Phiêu lưu"],
    tags: ["horror", "adv"],
    id: "37",
    reviews: [
